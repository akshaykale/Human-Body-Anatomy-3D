...
{
	//states of the diveplugin
	enum DivePluginState
	{
		IDLE,
		TRACKING,
		CALIBRATING,
	...
	[DllImport("divesensor")]
	private static extern int getState(ref int diveState);
	...
	void Update()
	{
		...
		int oldState = diveState;
		getState(ref diveState);
		if(oldState != diveState)
		{
			string str = "IDLE";
			switch(diveState){
				case 1: str = "TRACKING"; break;
				case 2: str = "CALIBRATING"; break;
				case 3: str = "LOADING"; break;
				case 4: str = "SAVING"; break;
			}
		}
#elif UNITY_IPHONE
		DiveUpdateGyroData();
		...
		{
			if(AddRotationGameobject)
				transform.rotation = RotationGameobject.transform.rotation * rot;
			else if (is_tablet==1){
